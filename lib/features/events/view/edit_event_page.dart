...
class EditEventPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => EditEventViewModel()..loadEventForEdit(eventId),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: viewModel.isLoading
                          ...
                          : viewModel.errorMessage != null && viewModel.eventData == null
                              ? Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () => viewModel.loadEventForEdit(eventId),
                                        child: Text('Retry'),
                                      ),
                                    ],
                                  ),
  ...
  Widget _buildPaidSection(EditEventViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildDescriptionSection(EditEventViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildSaveButton(EditEventViewModel viewModel) {
    return Container(
      width: double.infinity,
      height: 56.h,
      decoration: BoxDecoration(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: viewModel.isSaving ? null : viewModel.saveEvent,
          borderRadius: BorderRadius.circular(12.r),
          child: Center(
